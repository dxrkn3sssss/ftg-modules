 ...
 ​                    ​if message.text.lower() == "ивачка"
                         await message.edit(f"<a href=tg://user?id={me.id}>{me.first_name}</a> <b> Похмелдырда бошка бадум раскалында. Сушняк кошке рот накакалым. Сердце тыдын тыдын тыдын тыдын. Что с утра помоганда. Представляндр иновациндын средстволар от пахмелды. Шипучий хаш<\b> <a href=tg://user?id=​{​user​.​id​}​>​{​user​.​first_name​}​</a>"​) 
